...
public class BitMapLoader 
{
   ...
   public static void main(String[] args)
   {
	   ...
	   try 
	   {
		   writer = new PrintWriter("../../pixeldata.txt", "UTF-8");
	   }
	   ...
	   for(int i = 1; i <= 40;i++)
	   {
		   ...
		   for(int j = 1; j <= 9;j++)
		   {
			   ...
			   try 
			   { 
				   loadbitmap (new FileInputStream( (root + folder + file) ), writer ,(folder + file) );
			   }
   ...
   //*****************************************************
   public static void loadbitmap (InputStream fs,  PrintWriter writer, String fileName) 
   {
     ...
     writer.println("Image width and height: " + nwidth + ", " + nheight);  
     writer.println("Image padding: "+npad8);
     writer.println("Image length: " + bdata.length);
     writer.println("Image name: " + fileName);
